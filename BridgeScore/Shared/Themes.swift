    ...
    fileprivate static let themes: [ThemeName : ThemeConfig] = [
        .standard : ThemeConfig(
            background: [
                ...
                .grandTotal                  : ThemeColor(#colorLiteral(red: 0, green: 0, blue: 0.5019607843, alpha: 1), nil, .darkBackground),
                .subtotal1                   : ThemeColor(#colorLiteral(red: 0.7058823529, green: 0.7058823529, blue: 1, alpha: 1), nil, .lightBackground),
                .subtotal2                   : ThemeColor(#colorLiteral(red: 0.8039215686, green: 0.8039215686, blue: 1, alpha: 1), nil, .lightBackground),
                .subtotal3                   : ThemeColor(#colorLiteral(red: 0.8823529412, green: 0.8823529412, blue: 1, alpha: 1), nil, .lightBackground),
