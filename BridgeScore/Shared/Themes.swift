    ...
    fileprivate static let themes: [ThemeName : ThemeConfig] = [
        .standard : ThemeConfig(
            background: [
                ...
                .mutedTile                   : ThemeColor(#colorLiteral(red: 0.390437714, green: 0.704545175, blue: 0.7042515511, alpha: 1), #colorLiteral(red: 0.2, green: 0.2, blue: 0.2, alpha: 1), .midBackground, .darkBackground),
                ...
                .grandTotal                  : ThemeColor(#colorLiteral(red: 0, green: 0.1960784314, blue: 0.9990670085, alpha: 1), nil, .darkBackground),
                .subtotal1                   : ThemeColor(#colorLiteral(red: 0.6274509804, green: 0.6274509804, blue: 1, alpha: 1), nil, .darkBackground),
                .subtotal2                   : ThemeColor(#colorLiteral(red: 0.7843137255, green: 0.7843137255, blue: 0.9990670085, alpha: 1), nil, .darkBackground),
                .subtotal3                   : ThemeColor(#colorLiteral(red: 0.8823529412, green: 0.8823529412, blue: 1, alpha: 1), nil, .darkBackground),
                .grandTotal                  : ThemeColor(#colorLiteral(red: 0.0166248735, green: 0.4766505957, blue: 0.9990670085, alpha: 1), nil, .darkBackground),
                ...
                .disabledButton              : ThemeColor(#colorLiteral(red: 0.5882352941, green: 0.5882352941, blue: 0.5882352941, alpha: 1), #colorLiteral(red: 0.7843137255, green: 0.7843137255, blue: 0.7843137255, alpha: 1), .darkBackground),
                .enabledButton               : ThemeColor(#colorLiteral(red: 0.7843137255, green: 0.7843137255, blue: 0.7843137255, alpha: 1), #colorLiteral(red: 0.5215686275, green: 0.5058823529, blue: 0.5019607843, alpha: 1), .lightBackground),
                .highlightButton             : ThemeColor(#colorLiteral(red: 0, green: 0.568627451, blue: 0.5764705882, alpha: 1), #colorLiteral(red: 0, green: 0.568627451, blue: 0.5764705882, alpha: 1), .darkBackground),
                ...
                .handTable                   : ThemeColor(#colorLiteral(red: 0.1294117647, green: 0.8745098039, blue: 0.7058823529, alpha: 1), nil, .midBackground),
                ...
                .pass                        : ThemeColor(#colorLiteral(red: 0.1474743151, green: 0.707807149, blue: 0.173828125, alpha: 1), #colorLiteral(red: 0.1474743151, green: 0.6149400685, blue: 0.173828125, alpha: 1), .darkBackground, .darkBackground),
                .double                      : ThemeColor(#colorLiteral(red: 0.9211793664, green: 0, blue: 0, alpha: 1), #colorLiteral(red: 0.9211793664, green: 0, blue: 0, alpha: 1), .darkBackground, .darkBackground),
                .redouble                    : ThemeColor(#colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1), #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1), .darkBackground, .darkBackground)
            ],
            text: [
                .lightBackground             : ThemeTextColor(normal: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), contrast: #colorLiteral(red: 0.337254902, green: 0.4509803922, blue: 0.4549019608, alpha: 1), strong: #colorLiteral(red: 0.9981788993, green: 0.2295429707, blue: 0.1891850233, alpha: 1), faint: #colorLiteral(red: 0.7058823529, green: 0.7058823529, blue: 0.7058823529, alpha: 1), theme: #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1)) ,
                ...
                .midBackground               : ThemeTextColor(normal: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), contrast: #colorLiteral(red: 0.9411764706, green: 0.9411764706, blue: 0.9411764706, alpha: 1), strong: #colorLiteral(red: 0.9981788993, green: 0.2295429707, blue: 0.1891850233, alpha: 1),  faint: #colorLiteral(red: 0.7058823529, green: 0.7058823529, blue: 0.7058823529, alpha: 1), theme: #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1)) ,
            ...
            specific: [
                ...
                .redSuit                     : ThemeTraitColor(#colorLiteral(red: 0.8051958476, green: 0, blue: 0, alpha: 1), #colorLiteral(red: 0.6247056935, green: 0, blue: 0, alpha: 1)),
                .blackSuit                   : ThemeTraitColor(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), #colorLiteral(red: 0, green: 0.5152708056, blue: 0.7039544028, alpha: 1)),
                .ntSuit                      : ThemeTraitColor(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), #colorLiteral(red: 0, green: 0.5152708056, blue: 0.7039544028, alpha: 1)),
